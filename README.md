...
An MCP server for creating, modifying, and validating [Nomi.AI](https://nomi.ai) group chats. Scaffold group chat folders, add character Shared Notes, and validate character limits — all from any MCP-compatible client or editor. Prototype, version control, and modify your Group Chats.
...
1. Go to [nomi.ai](https://nomi.ai) and access the Shared Notes of the Nomi you want to modify
2. Navigate to each section, pasting in the contents of the `_Shared_Notes.md` file that your agent created
3. Remember to hit Save and resolve any over-the-limit character issues
...
4. Remember to hit save on the categories with changes, and resolve any over-the-limit character issues.
...
| `nomi-gc://guides/getting-started` | Knowledge primer for agents to teach them about Nomi.AI |
...
Feel free to email me your feature requests, bug reports, comments, and maybe some examples of cool things you make using this MCP.

spacegoblins@protonmail.com